...
- **Explains itself.** A "?" on the setup screen opens a plain-language guide to every option — including Mirror, which is for teleprompter glass rigs and not for reading off the phone. In portrait, Mirror also relocates the controls to the phone's reachable edge and turns them 180° to read normally, matching how a rig actually mounts the phone.
