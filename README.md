...
- **Explains itself.** A "?" on the setup screen opens a plain-language guide to every option — including Mirror, which turns the script a full 180° (not just left-to-right) for teleprompter rigs that mount the phone rotated. The controls never move and stay right-way-up, since you look at them directly rather than through the glass.
